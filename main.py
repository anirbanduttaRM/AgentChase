...
class Wolf:
    ...
    def move(self, rabbit, other_wolf):
        ...
        if self.strategy == "CHASE":
            ...
            flank_x = rabbit.x + 2 if rabbit.x < GRID_SIZE // 2 else rabbit.x - 2
            flank_y = rabbit.y + 2 if rabbit.y < GRID_SIZE // 2 else rabbit.y - 2
...
class CoordinatorAgent:
    ...
    def assign_strategies(self, rabbit):
        ...
        distances[1].strategy = "FLANK" if abs(distances[1].x - rabbit.x) > 3 else "CHASE"
